...
activity1 = Activity.new({"name" => "Yoga Beginners", "day" => "Thursday", "start_time" => "18:30", "end_time" => "20.00", "capacity" => 5})
activity2 = Activity.new({"name" => "Yoga Intermediate", "day" => "Tuesday", "start_time" => "18:00", "end_time" => "19.30", "capacity" => 5})
activity3 = Activity.new({"name" => "PowerSurge", "day" => "Monday", "start_time" => "07:15", "end_time" => "08:00", "capacity" => 5})
activity4 = Activity.new({"name" => "BoxFox", "day" => "Tuesday", "start_time" => "07:15", "end_time" => "08:00", "capacity" => 5})
activity5 = Activity.new({"name" => "DynaPump", "day" => "Wednesday", "start_time" => "07:15", "end_time" => "08:00", "capacity" => 5})
activity6 = Activity.new({"name" => "MegaStretch", "day" => "Thursday", "start_time" => "07:15", "end_time" => "08:00", "capacity" => 5})
activity7 = Activity.new({"name" => "RamboSmash", "day" => "Friday", "start_time" => "07:15", "end_time" => "08:00", "capacity" => 5})
activity8 = Activity.new({"name" => "BoxFox", "day" => "Saturday", "start_time" => "07:15", "end_time" => "08:00", "capacity" => 5})
activity9 = Activity.new({"name" => "BashCrash", "day" => "Sunday", "start_time" => "07:15", "end_time" => "08:00", "capacity" => 5})
activity10 = Activity.new({"name" => "BoxFox", "day" => "Wednesday", "start_time" => "18:15", "end_time" => "19.45", "capacity" => 5})
